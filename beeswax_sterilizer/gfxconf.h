...
#define INTERRUPTS_OFF()                            chSysLockFromISR();
#define INTERRUPTS_ON()                             chSysUnlockFromISR();

// Options that (should where relevant) apply to all operating systems
    #define GFX_NO_INLINE                            TRUE
...
//        #define GDISP_NEED_IMAGE_PNG_TRANSPARENCY    FALSE
...
#define GDISP_STARTUP_COLOR                          HTML2COLOR(0xEE9A49)
...
//        #define GWIN_FLASHING_PERIOD                 1000
...
//        #define GWIN_KEYBOARD_DEFAULT_LAYOUT         None
...
//    #define GWIN_NEED_FRAME                          FALSE
    #define GWIN_NEED_TABSET                         TRUE
        #define GWIN_TABSET_TABHEIGHT                32
